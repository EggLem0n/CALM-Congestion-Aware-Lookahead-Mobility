"""Path plots and GIF animation for classical MAPF runs."""
...
def animate_paths(
    ...
    for agent_id, (start, goal) in enumerate(zip(starts, goals)):
        ...
        ax.scatter([start[0]], [start[1]], marker="s", s=50, color=color, edgecolor="black", alpha=0.8)
    ...
    if speed_sequence is not None:
        ...
        scat = ax.scatter([], [], s=95, marker="o", edgecolor="black", linewidth=0.7)
    title = ax.set_title("")
